...
CA = "/home/pi/ssafy09204/Order_Verifier/secrets/CA1.pem"
PRIKEY = "/home/pi/ssafy09204/Order_Verifier/secrets/PRIVATE.key"
CERT = "/home/pi/ssafy09204/Order_Verifier/secrets/CERT.crt"
...
def read_QR(self, params, packet):
    ...
    if Order_Lists and product_num:
            ...
            if (Order_Lists[0][1][product_num]==0): #현재 주문 목록에 없는 상품이 찍히면 에러
                ...
                myMQTTClient.pbulish(PUB_ORD_MOTOR,"{\"power\":\"-1\"}",0)
