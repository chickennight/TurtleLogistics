...
.CustomerRegistForm input[type="number"]::-webkit-inner-spin-button,
.CustomerRegistForm input[type="number"]::-webkit-outer-spin-button {
  -webkit-appearance: none;
  margin: 0;
}

.CustomerRegistForm input[type="number"] {
